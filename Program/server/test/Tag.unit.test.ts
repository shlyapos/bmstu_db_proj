import { TagRepository } from '../src/repository/Tag'
...
@suite class TagRepositoryTest {
    private SUT: TagRepository;
    private testData: any;
    private testCUD: any;

    before() {
        this.SUT = new TagRepository(new ArrayStorage());
        this.testCUD = {
            id: 5,
            name: "IT"
        };
        ...
        this.testData = JSON.parse(fs.readFileSync(testPath, 'utf-8')).Tag;
