import { PostPictureRepository } from '../src/repository/PostPicture'
...
@suite class PostPictureRepositoryTest {
    private SUT: PostPictureRepository;
    private testData: any;
    private testCUD: any;

    before() {
        this.SUT = new PostPictureRepository(new ArrayStorage());
        this.testCUD = {
            id: 5,
            path: "/meme/pepe.jpg",
        };
        ...
        this.testData = JSON.parse(fs.readFileSync(testPath, 'utf-8')).PostPicture;
