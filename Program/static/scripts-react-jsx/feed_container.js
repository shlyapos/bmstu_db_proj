...
class RefreshButton extends React.Component {
    render() {
        return (
            <button className="refresh_button feed_element" onClick={this.props.function}>
                ...
                <p className="new_posts_count">12</p>   
            </button>
        );
    }
}
...
class App extends React.Component {
    ...
    addChild() {
        this.setState((state) => {
            ...
            {
                let newPosts = [];
                let lastPost = state.count + state.postInc;
    ...
    render(props) {
        ...
        return (
            <div>
                <RefreshButton function={this.addChild} />
                {
                    this.state.posts.map(item => <PostContainer key={item.id} author={item.author} content={item.content} />)
                }
            </div>
        );
    }
